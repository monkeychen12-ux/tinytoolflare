            ...
            >
              ...
              {header.brand?.title && (
                <div className="flex flex-col gap-0">
                  <span className="text-xl text-primary font-righteous font-bold tracking-wide">
                    {header.brand?.title || ""}
                  </span>
                  {header.brand?.slogan && (
                    <span className="text-xs bg-gradient-to-r from-purple-600 via-pink-500 to-orange-400 bg-clip-text text-transparent font-medium tracking-wide -mt-1 ml-1">
                      {header.brand?.slogan || ""}
                    </span>
                  )}
                </div>
